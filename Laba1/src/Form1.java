...
public class Form1 {
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 634, 412);
		...
		JButton buttonAddMilk = new JButton("\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u043C\u043E\u043B\u043E\u043A\u043E");
		JButton buttonAddSugar = new JButton("\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0441\u0430\u0445\u0430\u0440");
		JButton buttonAddSalt = new JButton("\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0441\u043E\u043B\u044C");
		JButton buttonAddOatmeel = new JButton("\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u043E\u0432\u0441\u044F\u043D\u044B\u0435 \u0445\u043B\u043E\u043F\u044C\u044F");
		JButton buttonGetOatmeel = new JButton("\u041F\u043E\u043B\u0443\u0447\u0438\u0442\u044C \u043E\u0432\u0441\u044F\u043D\u043A\u0443");
		JCheckBox checkBoxOn = new JCheckBox("\u0412\u043A\u043B");
		
		JButton buttonAddPan = new JButton("\u041F\u043E\u0441\u0442\u0430\u0432\u0438\u0442\u044C \u043A\u0430\u0441\u0442\u0440\u044E\u043B\u044E");
		buttonAddPan.setEnabled(false);
		
		JButton buttonCookMilk = new JButton("\u0413\u043E\u0442\u043E\u0432\u0438\u0442\u044C \u043C\u043E\u043B\u043E\u043A\u043E");
		buttonCookMilk.setEnabled(false);
		
		JButton buttonCookOatmeel = new JButton("\u0413\u043E\u0442\u043E\u0432\u0438\u0442\u044C \u043E\u0432\u0441\u044F\u043D\u043A\u0443");
		buttonCookOatmeel.setEnabled(false);
		
		JButton buttonGetPan = new JButton("\u0423\u0431\u0440\u0430\u0442\u044C \u043A\u0430\u0441\u0442\u0440\u044E\u043B\u044E");
		...
		buttonAddSugar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
	            ...
	            {
	            	JOptionPane.showMessageDialog(frame, "Сахара нет, что добавлять?", "Ошибка логики", JOptionPane.ERROR_MESSAGE);
	            }
	            buttonCookMilk.setEnabled(true);
			}
		});
		...
		buttonAddSalt.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	            ...
	            {
	            	JOptionPane.showMessageDialog(frame, "Соли нет, что добавлять?", "Ошибка логики", JOptionPane.ERROR_MESSAGE);
	            }
	            buttonCookMilk.setEnabled(true);
			}
		});
		...
		buttonAddOatmeel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				 if (oatmeel == null || oatmeel.length == 0)
		            ...
		            buttonAddPan.setEnabled(true);
		            buttonCookOatmeel.setEnabled(true);
		...
		buttonGetOatmeel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (pan.IsReadyOatmeel() && pan.IsReadyMilk())
	            {
	                ...
	                JOptionPane.showMessageDialog(frame, "Приятного аппетита!", "Кухня", JOptionPane.INFORMATION_MESSAGE);
	                return;
	            }
	            else
	            {
	            	JOptionPane.showMessageDialog(frame, "Овсянка ещё не готова", "Ошибка логики", JOptionPane.ERROR_MESSAGE);
	                return;
	            }
			}
		});
		...
		lblNewLabel_2.setBounds(10, 161, 233, 201);
		...
		buttonCookMilk.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (!pan.getReadyToGoMilk())
	            {
					JOptionPane.showMessageDialog(frame, "У нас не всё готово к варке", "Ошибка логики", JOptionPane.ERROR_MESSAGE);
	                return;
	            }
	            if (!stove.getState())
	            {
	            	JOptionPane.showMessageDialog(frame, "Нужно включить плиту", "Ошибка логики", JOptionPane.ERROR_MESSAGE);
	                return;
	            }
	            stove.CookMilk();
	            if (stove.getPan().IsReadyMilk())
	            {
	            	JOptionPane.showMessageDialog(frame, "Молоко вскипело, нужно добавить соль, сахар и овсянку", "Кухня", JOptionPane.INFORMATION_MESSAGE);
	                buttonCookMilk.setEnabled(false);
	                return;
	            }
	            else
	            {
	            	JOptionPane.showMessageDialog(frame, "Что-то пошло не так, овсянка не сварилась", "Ошибка логики", JOptionPane.ERROR_MESSAGE);
	                return;
	            }
			}
		});
		buttonCookMilk.setFont(new Font("Microsoft Sans Serif", Font.PLAIN, 11));
		buttonCookMilk.setBounds(48, 246, 163, 23);
		frame.getContentPane().add(buttonCookMilk);
		
		
		buttonCookOatmeel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (!stove.getState())
	            {
					JOptionPane.showMessageDialog(frame, "Нужно включить плиту", "Ошибка логики", JOptionPane.ERROR_MESSAGE);
	            ...
	            {
	            	JOptionPane.showMessageDialog(frame, "Овсянка готова, можно убирать с плиты", "Кухня", JOptionPane.INFORMATION_MESSAGE);
		...
		buttonCookOatmeel.setFont(new Font("Microsoft Sans Serif", Font.PLAIN, 11));
		buttonCookOatmeel.setBounds(48, 280, 163, 23);
		frame.getContentPane().add(buttonCookOatmeel);
		...
		buttonGetPan.setBounds(48, 312, 163, 23);
